    ...
    public static Dictionary<string, ReconciliationRow> Closure => new()
        {
            ...
            { "D", new(ReconciliationFieldName.SensitivityReviewDuration, PreservicaExportParser.ToInt)},
            { "E", new(ReconciliationFieldName.SensitivityReviewRestrictionCalculationStartDate, PreservicaExportParser.ToDate)},
            { "F", new(ReconciliationFieldName.LegislationSectionReference, PreservicaExportParser.ToTextList)},
            { "G", new(ReconciliationFieldName.SensitivityReviewDate, PreservicaExportParser.ToDate)},
            { "H", new(ReconciliationFieldName.IsPublicName, PreservicaExportParser.ToBool)},
            { "I", new(ReconciliationFieldName.SensitivityReviewSensitiveName, PreservicaExportParser.ToText)}
        };
}
