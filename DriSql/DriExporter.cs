...
public class DriExporter(ILogger<DriExporter> logger, IOptions<DriSettings> options) : IDriSqlExporter
{
    ...
    create index deliverableunitmanifestation_ix on deliverableunitmanifestation (DELIVERABLEUNITREF, DELETED)
    ...
    private readonly string fileXmlSql = """
        ...
        where f.DELETED = 'F' and dm.DELETED = 'F' and d.DELETED = 'F' and
