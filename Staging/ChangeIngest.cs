...
public class ChangeIngest(ICacheClient cacheClient, ISparqlClient sparqlClient,
    ILogger<ChangeIngest> logger, IMeterFactory meterFactory) :
    StagingIngest<DriChange>(sparqlClient, logger, meterFactory, "ChangeGraph")
{
