...
public class StagingReconciliationClient(IReconciliationSparqlClient sparqlClient) : IStagingReconciliationClient
{
    ...
    private static Dictionary<string, RowInfo> Map => new()
    {
        ...
        { Vocabulary.ImportLocation.Uri.Segments.Last(), new(ReconciliationFieldName.Location, ToText) },
        ...
        { Vocabulary.VariationName.Uri.Segments.Last(), new(ReconciliationFieldName.Name, ToText) },
        { Vocabulary.AssetDriId.Uri.Segments.Last(), new(ReconciliationFieldName.Id, ToText) },
        { "startOriginDate", new(ReconciliationFieldName.CoveringDateStart, ToText) },
        { "endOriginDate", new(ReconciliationFieldName.CoveringDateEnd, ToText) },
        ...
        { Vocabulary.SensitivityReviewDate.Uri.Segments.Last(), new(ReconciliationFieldName.FoiAssertedDate, ToDateTime) },
        { Vocabulary.SensitivityReviewSensitiveName.Uri.Segments.Last(), new(ReconciliationFieldName.SensitiveName, ToText) },
